...
// aliasDentry is a DentryImpl that shares its watch set with the other hard
// link aliases of the same file.
...
// TestWatchesHasTarget verifies that HasTarget distinguishes dentries sharing a
// watch set.
...
// TestSharedWatchSetOnZeroWatches verifies that a dentry is released as soon as
// no watch targets it, even while the shared set is non-empty.
